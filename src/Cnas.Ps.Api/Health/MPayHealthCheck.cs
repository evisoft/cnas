...
/// <summary>
/// Readiness probe for the MPay electronic-payments MGov platform service. Empty base
/// URL → degraded; otherwise GET <c>{base}/health</c> via <see cref="HttpReachabilityProbe"/>.
/// </summary>
...
public sealed class MPayHealthCheck(
    ...
    IOptions<MGovOptions> options) : IHealthCheck
{
    ...
    private const string ProbePathTag = "mgov.mpay.ready";
