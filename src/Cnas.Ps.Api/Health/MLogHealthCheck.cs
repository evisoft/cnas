...
/// <summary>
/// Readiness probe for the MLog central-government journaling service.
/// </summary>
...
public sealed class MLogHealthCheck(
    ...
    IOptions<MGovOptions> options) : IHealthCheck
{
    ...
    private const string ProbePathTag = "mgov.mlog.ready";
