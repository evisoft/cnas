...
/// <summary>
/// Readiness probe for the MConnect interoperability MGov platform service.
/// </summary>
...
public sealed class MConnectHealthCheck(
    ...
    IOptions<MGovOptions> options) : IHealthCheck
{
    ...
    private const string ProbePathTag = "mgov.mconnect.ready";
