...
{
    /// <summary>
    /// R0673 / TOR CF 18.12 — placeholder migration for the additive
    /// <c>cnas.GranularPermissionAssignments</c> table introduced in iter-135.
    /// </summary>
    /// <remarks>
    ...
    /// <see cref="Cnas.Ps.Core.Domain.GranularPermissionAssignment"/> entity
    /// and its EF mapping are already wired into the production
    /// <see cref="Cnas.Ps.Infrastructure.Persistence.CnasDbContext"/> so the
    /// in-memory test provider creates the table on first use.
    /// </remarks>
    public partial class AddGranularPermissionAssignments : Migration
    {
        /// <inheritdoc />
